...
public class User {
    ...
    public void doLogin(final String user, final String password, final ServerCallback callback) {
        String url ="http://www.link2loyalty.com/AsistenciasL2L/api/ValidaMasServicios"; /*"http://www.link2loyalty.com/AsistenciasL2L/api/ValidaAnaGo";*/ //"http://link2loyalty.com/AsistenciasL2L/api/_LoginAsis";*/
        // Request a string response from the provided URL.
        StringRequest stringRequest = new StringRequest(
                Request.Method.POST,
                url,
